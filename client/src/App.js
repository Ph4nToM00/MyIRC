                ...
                <div className="flex justify-center text-center p-8">
                    <div className="username">
                        ...
                        <form>
                            ...
                            <button onClick={this.handlePseudo} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">Se connecter</button>
                        </form>
                    </div>
                </div>
            )
                    ...
                    <div className="flex justify-center py-8">
                        <div className="max-w-sm bg-white border-2 border-gray-300 p-6 rounded-md tracking-wide shadow-lg">
                            <div className="rounded text-center relative -mb-px block border  border-grey px-4">
                                channels <br/>
                                <p className='font-bold text-red-700'>{this.affichChannels()}</p>
                            </div>
                            <div className="text-center">
                                <em>Bienvenue { this.state.username } sur le channel <p className='font-bold'>{this.state.channelSelected}</p></em>
                        ...
                        <span className="border rounded-lg">
                            <div className="sendForm">
                                <form >
                                    ...
                                    <button  className="inline-block px-6 py-2 text-xs font-medium leading-6 text-center text-white uppercase transition bg-blue-300 hover:bg-blue-700 rounded-full shadow ripple waves-light hover:shadow-lg focus:outline-none" onClick={this.handleMessage}>Envoyer</button>
                                </form>
                            </div>
                        </span>
                    </div>
                    ...
                    <footer className="flex flex-wrap items-center justify-between p-3 m-auto">
                        <div className="container mx-auto flex flex-col flex-wrap items-center justify-between">
                            <div className="members">
                                Liste des membres :
                                <p className='font-bold'>{this.affichMembers()}</p>
                            </div>
                        </div>
                    </footer>
                    </div>
